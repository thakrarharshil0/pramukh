            ...
            <div className="w-full lg:w-[400px] min-[2500px]:w-[600px] flex flex-col gap-10">
              ...
              <div className="flex flex-col gap-6">
                ...
                <div className="flex flex-col gap-6">
                  ...
                  <ContactItem icon={<Building size={22} />} title="Head Office - Hyderabad" value="301, 3rd floor, Masetty Plaza, 1-8-206, Prenderghast Road, Secunderabad, Telangana-500003" isHeadOffice={true} />
